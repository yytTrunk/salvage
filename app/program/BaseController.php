...
class BaseController extends \app\BaseController
{
    ...
    protected $hclm_appid = "wx243cc6ee6c4fa4fd";
    protected $hclm_appSecret = "b8603edb09ac95d6189f7312f5907590";
    ...
    protected function posturl($url,$data){
        $headerArray =array("Content-Type:text/xml; charset=utf-8");
        $curl = curl_init();
        curl_setopt($curl, CURLOPT_URL, $url);
        curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, FALSE);
        curl_setopt($curl, CURLOPT_SSL_VERIFYHOST,FALSE);
     ...
     * @param $message
     */
//    public function sendMessageToUser($openId = 'oMDMJ5XJ0XfwpnDhQfM3N3M7Su-E',$message = '测试消息') {
//        $accessToken = self::getAccessToken();
...
//    }
     ...
     */
    public function mess($tel = '18336581907') {
